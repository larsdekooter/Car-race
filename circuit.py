...
def point_lines(screen):
    return np.flip(
        [
            ...
            SuccesLine(
                3,
                lambda x: pygame.draw.line(screen, "green", (55, 320), (140, 320)),
                (55, 320),
                (140, 320),
            ),
            SuccesLine(
                2,
                lambda x: pygame.draw.line(screen, "green", (50, 350), (117, 350)),
                (50, 350),
                (117, 350),
            ),
            SuccesLine(
            ...
            SuccesLine(
                0,
                lambda x: pygame.draw.line(screen, "green", (52, 550), (103, 553)),
                (52, 550),
                (103, 553),
            ),
        ]
